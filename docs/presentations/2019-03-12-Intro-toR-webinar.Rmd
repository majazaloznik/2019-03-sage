...
???
R is currenlty one of the most popular platforms for data analysis, with an expanding user base as well as ever expanding funcitonality.
--
...
Because R is opensource and free, and available on Widnows, Mac and linux. 
...
So I turned this chart into an interactive one using shiny, which is an r package for creating interactive visualisations.
 This was actually the first interactive viz i made. So let's see if I can get it up and running.
